...
// When the user scrolls down from the top of the document, resize the header's display
...
function scrollFunction() {
  if (document.body.scrollTop > 1 || document.documentElement.scrollTop > 1) {
    document.getElementById("contact-topbar").style.display = "none";
  } else {
    document.getElementById("contact-topbar").style.display = "block";
  }
}
